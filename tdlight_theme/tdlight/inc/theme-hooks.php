...
<?php    }
     ...
     function sort_terms_found( $terms, $taxonomies, $args, $term_query ) {
        ...
        if ( ! is_admin() ) :
            ...
            if ( $terms ) :
                ...
                $_terms = array_merge( $array_terms['group'], 
            ...
            if ( $terms ) :
                ...
                foreach ( $terms as $term ) : 
                    ...
                    if ( $priority ) :
                        ...
                        if ( ! is_array( $array_terms['group'] ) ) :

                            $array_terms['group'] = array();

                        endif;

                        if ( ! is_array( $array_terms['group'][ $priority ] ) ) :

                            $array_terms['group'][ $priority ] = array();
                        ...
                        if ( ! is_array( $array_terms['notgroup'] ) ) :

                            $array_terms['notgroup'] = array();
                ...
                $_terms = $array_terms['group'];

                $keys = array_keys( $_terms );
                $size_keys = count( $keys );

                $k = intval( $keys[ $size_keys - 1 ] ) + 1;

                $_terms[ $k ] = $array_terms['notgroup'];
    ...
    add_filter( 'get_posts', 'sort_posts_found', 10, 4 );*/