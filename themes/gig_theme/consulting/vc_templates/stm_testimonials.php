...
<?php if( $style == 'style_3' || $style == 'style_4' ) : ?>
					...
					<?php while ( $testimonials->have_posts() ): $testimonials->the_post(); ?>
						<div class="item" data-image="<?php echo esc_url( wp_get_attachment_image_url( get_post_meta( get_the_ID(), 'testimonial_bg_img', true ), true ) ); ?>">
							...
							<div class="testimonial_info">
								...
								?>
								<p><?php if( $style == 'style_3' ) : ?><strong><?php endif; ?><?php echo esc_html( join(', ', $testimonial_author_info) ); ?><?php if( $style == 'style_3' ) : ?></strong><?php endif; ?></p>
							</div>
						</div>
					<?php endwhile; ?>
				</div>
