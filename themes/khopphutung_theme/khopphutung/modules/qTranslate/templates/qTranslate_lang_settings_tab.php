<div id="col-left">
    ...
    <div class="col-wrap">
        ...
        <div class="navtab-content">
            ...
            <h3>Thêm ngôn ngữ mới</h3>

            <form method="post" action="<?php echo $_SERVER['REQUEST_URI'] ?>">

                <div class="nav-groupbox mtop20">

                    <label for="slqtransLangBox">Mời chọn một ngôn ngữ</label>
                ...
                <div class="nav-groupbox mtop20">
                    ...
                    <label for="txtqtransLangName">Tên ngôn ngữ</label>
                 ...
                 <div class="nav-groupbox mtop20">
                    ...
                    <label for="txtqtransLangLocale">Mã khu vực</label>
                ...
                <div class="nav-groupbox mtop20">
                    ...
                    <label for="txtqtransLangCode">Mã ngôn ngữ</label>
                ...
                <div class="nav-groupbox mtop20">
                    ...
                    <button class="button button-primary" name="btnNewLanguageSubmit" type="submit">Thêm ngôn ngữ</button>
    ...
    <div class="col-wrap">
        ...
        <div class="qtranslate-notify pull-right mtop20">
            ...
            <?php if ( $lang_packages ) : 
                    ...
                    echo sizeof( $lang_packages ) . ' ngôn ngữ đã được thêm vào.';

                  else :

                    echo 'Chưa có ngôn ngữ nào được thêm.';
        ...
        <table class="wp-list-table widefat fixed striped languages mtop35 w100p">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th>
                        <a href="#">Cờ ngôn ngữ</a>
                    </th>

                    <th>
                        <a href="#">Tên ngôn ngữ</a>
                    </th>
                    ...
                    <th>
                        <a href="#">Mã ngôn ngữ</a>
                    </th>

                    <th class="tcenter">   
                        <a href="#">Ngôn ngữ mặc định</a>
                    </th>
                        ...
                        <tr>
                            ...
                            <td class="tcenter"> 
                                ...
                                <?php if ( 0 == $lang->ldefault ) : ?>
                                    ...
                                    <a href="<?php echo admin_url( "$current_screen->parent_file?page=$this->option_page_url&set_default_lang=$lang->name" ) ?>">Thiết lập mặc định</a>
