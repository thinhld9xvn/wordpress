<?php 
    ...
    class pitvietco_slider_widget extends WP_Widget {	
    	...
    	function pitvietco_slider_widget() {
    		...
    		$widget_ops = array( 'classname' => 'pitvietco-slider', 'description' => 'pitvietco - Hiển thị slider' );
    
    		$control_ops = array( 'width' => 400, 'height' => 350, 'id_base' => 'pitvietco-slider' );		
    
    		$this->WP_Widget( 'pitvietco-slider', 'pitvietco - Hiển thị slider', $widget_ops, $control_ops );
