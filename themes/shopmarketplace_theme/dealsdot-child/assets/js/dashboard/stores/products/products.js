...
import { onClick_chooseMediaThumbnailProductEvent } from './handleEvents/onClick_chooseMediaThumbnailProductEvent.js'
...
$galleriesItem.length && 
    $galleriesItem.click(onClick_chooseMediaThumbnailProductEvent);
