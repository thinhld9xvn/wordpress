...
class MyThemeOptionPage {
     ...
     */       
     public function __construct() {
        ...
        include THEME_CHILD_DIR . '/options/theme_options.php';
    ...
    public function add_plugin_page() {
        ...
        add_menu_page(__( 'Theme Option', 'pitvietco' ), // Thay title của trang Theme Option
            ...
            'manage_options', 'theme-option', null, THEME_CHILD_DIR_URI . '/theme_settings/theme_options/theme_option.png' // Thay icon của bạn
            );           
...
function theme_option_load_style() {
    ...
    if ( false !== strpos( $request_uri, 'theme-option' ) ) :
        ...
        wp_enqueue_style( 'dealsdot-themeoption-style' , THEME_CHILD_DIR_URI . '/theme_settings/theme_options/css/style.min.css' );
        wp_enqueue_script( 'dealsdot-themeoption-field-media-js' , THEME_CHILD_DIR_URI . '/theme_settings/theme_options/js/field_media.min.js' );
        wp_enqueue_script( 'dealsdot-themeoption-field-editor-js' , THEME_CHILD_DIR_URI . '/theme_settings/theme_options/js/field_editor.min.js' );
        wp_enqueue_script( 'dealsdot-themeoption-typical-js' , THEME_CHILD_DIR_URI . '/theme_settings/theme_options/js/field_typical.min.js' );

        //$combine_admin_enqueue['stylesheet'][] = THEME_CHILD_DIR_URI . '/theme_settings/theme_options/css/style.min.css';
        
        //$combine_admin_enqueue['scripts'][] = THEME_CHILD_DIR_URI . '/theme_settings/theme_options/js/field_media.min.js';
        //$combine_admin_enqueue['scripts'][] = THEME_CHILD_DIR_URI . '/theme_settings/theme_options/js/field_editor.min.js';                
        //$combine_admin_enqueue['scripts'][] = THEME_CHILD_DIR_URI . '/theme_settings/theme_options/js/field_typical.min.js';                       
