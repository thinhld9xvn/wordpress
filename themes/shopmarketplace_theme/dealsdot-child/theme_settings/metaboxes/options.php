<?php 
    ...
    define('METABOX_DIRECTORY_URI', THEME_CHILD_DIR_URI . '/theme_settings/metaboxes');
    define('METABOX_DIRECTORY', THEME_CHILD_DIR_URI . '/theme_settings/metaboxes');

    define('METABOX_DIRECTORY_OPTIONS', THEME_CHILD_DIR . '/options');
