<?php 
    ...
    define('METABOX_DIRECTORY_URI', MY_THEME_DIR_URI . '/theme_settings/metaboxes');
    define('METABOX_DIRECTORY', MY_THEME_DIR_URI . '/theme_settings/metaboxes');

    define('METABOX_DIRECTORY_OPTIONS', MY_THEME_DIR . '/options');
    ...
    function meta_boxes_register_stylesheet() { 
        ...
        if ( $metabox_terms_enqueue_scripts ) :                
            ...
            if ( false !== strpos( $request_uri, 'edit-tags.php' ) ) :
                ...
                wp_enqueue_script( 'dealsdot-metaboxes-field_accordion-js' , METABOX_DIRECTORY_URI . '/js/field_accordion.js' );
                wp_enqueue_script( 'dealsdot-metaboxes-field_editor-js' , METABOX_DIRECTORY_URI . '/js/field_editor.min.js' );
                wp_enqueue_script( 'dealsdot-metaboxes-field_media-js' , METABOX_DIRECTORY_URI . '/js/field_media.js' );
                ...
                //$combine_admin_enqueue['scripts'][] = dirname(__FILE__) . '/js/field_accordion.js';                                      
