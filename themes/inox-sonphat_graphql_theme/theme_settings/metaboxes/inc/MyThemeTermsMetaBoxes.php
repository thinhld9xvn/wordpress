            ...
            <tr>
                        ...
                        <?php 
                            ...
                            if ( is_array( $media_term_field ) && sizeof( $media_term_field ) > 0 ) :
                                ...
                                foreach ( $media_term_field as $media_field_value ): ?>
                                    ...
                                    <div class="field field-media mtop10">
                                       
                                       <?php if ( $field['thumbnail'] || ! isset( $field['thumbnail'] ) ) : ?>
                                           <img width="100" 
                                                src="<?php echo $media_field_value ? $media_field_value : METABOX_DIRECTORY_IMAGES_URI . '/empty-thumbnail.png' ?>" 
                ...
                <?php               $count_field++;                    
                             ...
                             <div class="field field-media mtop10">
                                 ...
                                 <?php if ( $field['thumbnail'] || ! isset( $field['thumbnail'] ) ) : ?>
                                     <img width="100" 
                                            src="<?php echo $term_meta[ $field['id'] ] ? $term_meta[ $field['id'] ] : METABOX_EMPTY_THUMBNAIL_URI ?>" 
                                            class="thumbnail_media_field_metabox vmiddle" />
                                 <?php endif; ?>
