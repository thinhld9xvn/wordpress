	...
	<div class="container">
		...
		<div class="colright padleft20-md padleft20-sm mtop20-xs col-md-9 col-sm-9 col-xs-12">	
			...
			<div class="rownewsbox">
				...
				<!-- newsboxcontent -->
				<div class="newsboxcontent split-columns four-columns-layout" data-navig="setequalheight" data-object=".newsb" data-css-delimiter-property="clear" data-css-delimiter-value="both" data-setheight=".title">
