...
require_once plugin_dir_path(__FILE__) . 'pitvietco_home_show_new_products_widget.php';
require_once plugin_dir_path(__FILE__) . 'pitvietco_home_show_carousel_articles_widget.php';
require_once plugin_dir_path(__FILE__) . 'pitvietco_home_show_news_list_widget.php';