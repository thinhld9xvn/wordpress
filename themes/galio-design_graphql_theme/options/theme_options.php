<?php
    ...
    $this->sections[] = \Theme_Options\ThemeOptionsGetSliderSectionUtils::get();

    $this->sections[] = \Theme_Options\ThemeOptionsGetHomeSectionUtils::get();

    $this->sections[] = \Theme_Options\ThemeOptionsGetFooterSectionUtils::get();
    
    $this->sections[] = \Theme_Options\ThemeOptionsGetSocialNetworkSectionUtils::get();
