<?php 
    ...
    define('STYLESHEET_COMBINE_ADMIN_FILE_URI', CACHE_DIRECTORY_URI . '/pitviet-admin-stylesheet-combines-one.css');
    define('STYLESHEET_COMBINE_ADMIN_FILE_PATH', CACHE_DIRECTORY . '/pitviet-admin-stylesheet-combines-one.css');

    define('JAVASCRIPT_COMBINE_ADMIN_FILE_URI', CACHE_DIRECTORY_URI . '/pitviet-admin-script-combines-one.js');
    define('JAVASCRIPT_COMBINE_ADMIN_FILE_PATH', CACHE_DIRECTORY . '/pitviet-admin-script-combines-one.js');     
    ...
    class WP_HTML_Compression
    {
    	...
    	public function __construct($html)
    	{
    		if ( ! empty( $html ) ) :
    			...
    			$this->parseHTML( $html ); 
                //$this->combineAllStyleScripts( $html );
