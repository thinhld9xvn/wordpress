	            					...
	            					if (  $key >= 0 ) : //print_r( $c_field ); ?>
				            			...
				            			<div class="pvcf-field pvcf-field-box postbox closed mtop20">
				            				...
				            				<div class="pvcf-field-section-body inside mtop20">
						            			...
						            			<!-- pvcf-field-cg -->
					            				<div class="pvcf-field-cg pvcf-field-cg-hidden select textarea textbox email tel pvcf-field-require-cg mtop10 <?= $c_field['pvcf-field-type-value'] === 'submit' ? 'hidden' : '' ?>">
