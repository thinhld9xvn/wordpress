    ...
    public function print_field_range_type_callback($field, $section) {
            ...
            ob_start(); ?>
                ...
                <div class="theme_field_box">
                    <input id="<?php echo $field['id'] . '-id' ?>" class="txtRangeObj" type="range" min="<?php echo $field['min'] ?>" max="<?php echo $field['max'] ?>" step="<?php echo $field['step'] ?>" value="<?= isset( $this->options[ $field['id'] . '-id' ] ) ? esc_attr( $this->options[ $field['id'] . '-id' ] ) : $field['value'] ?>" />
    ...
    public function print_field_select_type_callback($field, $section) {
        ...
        ob_start(); ?>
            ...
            <div class="theme_field_box">
                ...
                <select id="<?php echo $field['id'] . '-id-selectbox' ?>" class="selectFieldBox">
...
if ( is_admin() ) :
    ...
    function theme_option_load_style() {
        ...
        if ( 0 === strpos( get_current_screen()->id, 'theme-option' ) ) :
        	...
        	wp_enqueue_script('my-theme-option-jquery-config',  get_template_directory_uri() . '/theme_settings/theme_options/js/config.min.js', array('jquery'), '1.0.0', true);
        	...
        	wp_enqueue_script('my-theme-option-jquery-field-range',  get_template_directory_uri() . '/theme_settings/theme_options/js/field_range.min.js', array('jquery'), '1.0.0', true);
        	...
        	wp_enqueue_script('my-theme-option-jquery-field-select',  get_template_directory_uri() . '/theme_settings/theme_options/js/field_select.min.js', array('jquery'), '1.0.0', true);
