        ...
        onAutoSwitchMenu: function(e) {
            ...
            if ( window.innerWidth > 768 ) {
                ...
                var $menu = $('#menu'),
                    ...
                    menu_width = $menu.closest('.menu').width(),

                    menu_items_totalwidth = 0;

                if ( $menu.data('menu_items_totalwidth') === undefined ) {

                    var $menu_items = $('#menu ul#main-menu > li'),                        
                    ...
                    console.log( menu_items_totalwidth );

                    menu_items_totalwidth += margin_total;   

                    $menu.data('menu_items_totalwidth', menu_items_totalwidth);

                }

                else {
                     menu_items_totalwidth = $menu.data('menu_items_totalwidth');
                }
