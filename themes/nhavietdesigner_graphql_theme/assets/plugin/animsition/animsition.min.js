    ...
    var i = "animsition",
        a = {
            init: function(o) {
                ...
                return e || !(o.browser.length > 0) || e && this.length ? (a.optionCheck.call(this, o) && t("." + o.overlayClass).length <= 0 && a.addOverlay.call(this, o), o.loading && t("." + o.loadingClass).length <= 0 && a.addLoading.call(this, o), this.each(function() {
                    var e = this,
                        ...
                        l = t(window),
                        r = t(document);
                    s.data(i) || (o = t.extend({}, o), s.data(i, {
                        options: o
                    }), o.timeout && a.addTimer.call(e), o.onLoadEvent && (n ? (a.settings.timer && clearTimeout(a.settings.timer), a.in.call(e)) : l.on("load.animsition", function() {
                        a.settings.timer && clearTimeout(a.settings.timer), a.in.call(e)
                    })), l.on("pageshow.animsition", function(t) {
                        t.originalEvent.persisted && a.in.call(e)
                    }), l.on("unload.animsition", function() {}), r.on("click.animsition", o.linkElement, function(n) {
                        n.preventDefault();
                        var i = t(this),
                            o = i.attr("href");
            ...
            animationCheck: function(n, a, o) {
                var e = t(this).data(i).options,
                    s = typeof n,
                    l = !a && "number" === s,
                    r = a && "string" === s && n.length > 0;
                return l || r ? n = n : a && o ? n = e.inClass : !a && o ? n = e.inDuration : a && !o ? n = e.outClass : a || o || (n = e.outDuration), n
            },
            in: function() {
                var n = this,
                    o = t(this),
                    ...
                    r = a.animationCheck.call(n, s, !1, !0),
                    d = a.animationCheck.call(n, l, !0, !0),
                    u = a.optionCheck.call(n, e),
                    c = o.data(i).outClass;
                e.loading && a.removeLoading.call(n), c && o.removeClass(c), u ? a.inOverlay.call(n, d, r) : a.inDefault.call(n, d, r)
            },
            ...
            out: function(n, o) {
                var e = this,
                    s = t(this),
                    l = s.data(i).options,
                    r = n.data(a.settings.data.outClass),
            ...
            outOverlay: function(n, o, e) {
                var s = this,
                    l = t(this),
                    r = l.data(i).options,
                    d = l.data(a.settings.data.inClass),
                ...
                t(r.overlayParentElement).children("." + r.overlayClass).css({
                    ...
                    l.trigger(a.settings.events.outEnd), r.transition(e)
                })
            },
            destroy: function() {
