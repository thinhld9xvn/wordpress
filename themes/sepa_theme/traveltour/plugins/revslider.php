<?php
	...
	add_filter('revslider_getUsedFonts', 'traveltour_revslider_getUsedFonts');
	if( !function_exists('traveltour_revslider_getUsedFonts') ){
		function traveltour_revslider_getUsedFonts( $used_font ){
