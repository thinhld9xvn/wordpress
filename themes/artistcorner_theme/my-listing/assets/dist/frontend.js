    ...
    function o() {
        ...
        return n.prototype = {
            ...
            return function(p, n, e, t) {
                ...
                function u(e, t) {
                    if (!g.loop && t) {
                        var i = H + (qe.x * Ve - e) / qe.x,
                            n = Math.round(e - bt.x);
                        (i < 0 && 0 < n || i >= Ht() - 1 && n < 0) && (e = bt.x + n * g.mainScrollEndFriction)
                    }
                    bt.x = e, nt(e, Q)
                }
                ...
                function $(e, t) {
                    var i, n, a, s, o = Qe[e] + t[e],
                        ...
                        l = bt.x + t.x,
                        c = bt.x - ft.x;
                    if (i = o > Ae.min[e] || o < Ae.max[e] ? g.panEndFriction : 1, o = Qe[e] + t[e] * i, (g.allowPanToNext || Z === m.currItem.initialZoomLevel) && (Ye ? "h" !== $e || "x" !== e || Me || (r ? (o > Ae.min[e] && (i = g.panEndFriction, Ae.min[e] - o, n = Ae.min[e] - He[e]), (n <= 0 || c < 0) && 1 < Ht() ? (s = l, c < 0 && l > ft.x && (s = ft.x)) : Ae.min.x !== Ae.max.x && (a = o)) : (o < Ae.max[e] && (i = g.panEndFriction, o - Ae.max[e], n = He[e] - Ae.max[e]), (n <= 0 || 0 < c) && 1 < Ht() ? (s = l, 0 < c && l < ft.x && (s = ft.x)) : Ae.min.x !== Ae.max.x && (a = o))) : s = l, "x" === e)) return void 0 !== s && (u(s, !0), Ie = s !== ft.x), Ae.min.x !== Ae.max.x && (void 0 !== a ? Qe.x = a : Ie || (Qe.x += t.x * i)), void 0 !== s;
                ...
                function K(e) {
                    if (!("mousedown" === e.type && 0 < e.button))
                        ...
                        var i = j(e),
                            n = i.length;
                        Le = null, _(), Ce && 1 !== n || (Ce = Ke = !0, f.bind(window, V, m), De = Re = Oe = ke = Ie = Te = Se = Me = !1, $e = null, y("firstTouchStart", i), w(He, Qe), Ne.x = Ne.y = 0, w(ut, i[0]), w(ht, ut), ft.x = qe.x * Ve, mt = [{
                            x: ut.x,
                            y: ut.y
                        }], we = ve = d(), b(Z, !0), xt(), function e() {
                            Ce && (_e = de(e), _t())
                        }()), !Ee && 1 < n && !je && !Ie && (z = Z, Ee = Se = !(Me = !1), Ne.y = Ne.x = 0, w(He, Qe), w(lt, i[0]), w(ct, i[1]), A(lt, ct, kt), Dt.x = Math.abs(kt.x) - Qe.x, Dt.y = Math.abs(kt.y) - Qe.y, Pe = L(lt, ct))
                    }
                }
                ...
                function F(e) {
                    ...
                    var o = -1;
                    if (0 === s && (Ce = !1, f.unbind(window, V, m), xt(), Ee ? o = 0 : -1 !== wt && (o = d() - wt)), wt = 1 === s ? d() : -1, n = -1 !== o && o < 150 ? "zoom" : "swipe", Ee && s < 2 && (Ee = !1, 1 === s && (n = "zoomPointerUp"), y("zoomGestureEnded")), Le = null, Te || Me || je || ke)
                ...
                var R, B, N, H, Q, U, V, W, q, Z, z, G, X, J, ee, te, ie, ne, ae, se, oe, re, le, ce, de, ue, he, pe, fe, me, ge, ye, ve, we, be, De, ke, xe, Ce, Se, Me, Te, _e, Ie, Le, Ee, Pe, Ae, Ye, je, $e, Ke, Oe, Fe, Re, Be, Ne = {
                        x: 0,
                        y: 0
                    },
                    He = {
                    ...
                    rt = {
                        ...
                        init: function() {
                            if (!R && !B) {
                                ...
                                y("firstUpdate"), H = H || g.index || 0, (isNaN(H) || H < 0 || H >= Ht()) && (H = 0), m.currItem = Nt(H), (ge.isOldIOSPhone || ge.isOldAndroid) && (ze = !1), p.setAttribute("aria-hidden", "false"), g.modal && (ze ? p.style.position = "fixed" : (p.style.position = "absolute", p.style.top = f.getScrollY() + "px")), void 0 === me && (y("initialLayout"), me = pe = f.getScrollY());
                                var i = "pswp--open ";
                                ...
                                fe || f.bind(m.scrollWrap, W, m), s("initialZoomInEnd", function() {
                                    m.setContent(te[0], H - 1), m.setContent(te[2], H + 1), te[0].el.style.display = te[2].el.style.display = "block", g.focus && p.focus(), f.bind(document, "keydown", m), ge.transform && f.bind(m.scrollWrap, "click", m), g.mouseUsed || f.bind(document, "mousemove", o), f.bind(window, "resize scroll orientationchange", m), y("bindEvents")
                                }), m.setContent(te[1], H), m.updateCurrItem(), y("afterInit"), ze || (J = setInterval(function() {
                        ...
                        goTo: function(e) {
                            var t = (e = l(e)) - H;
                            Ze = t, H = e, m.currItem = Nt(H), Ve -= t, u(qe.x * Ve), _(), je = !1, m.updateCurrItem()
                        },
                        next: function() {
                            m.goTo(H + 1)
                        },
                        ...
                        updateCurrItem: function(e) {
                            if (0 !== Ze) {
                                var t, i = Math.abs(Ze);
                                if (!(e && i < 2)) {
                                    m.currItem = Nt(H), Je = !1, y("beforeChange", Ze), 3 <= i && (U += Ze + (0 < Ze ? -3 : 3), i = 3);
                                    for (var n = 0; n < i; n++) 0 < Ze ? (t = te.shift(), te[2] = t, nt((++U + 2) * qe.x, t.el.style), m.setContent(t, H - i + n + 1 + 1)) : (t = te.pop(), te.unshift(t), nt(--U * qe.x, t.el.style), m.setContent(t, H + i - n - 1 - 1));
                                    if (Ye && 1 === Math.abs(Ze)) {
                                        var a = Nt(ie);
                                        a.initialZoomLevel !== Z && (qt(a, Ue), Zt(a), it(a))
                                    }
                                    Ze = 0, m.updateCurrZoomItem(), ie = H, y("afterChange")
                                }
                            }
                        },
                        updateSize: function(e) {
                            ...
                            if (Ue.x = m.scrollWrap.clientWidth, Ue.y = m.scrollWrap.clientHeight, S(), qe.x = Ue.x + Math.round(Ue.x * g.spacing), qe.y = Ue.y, u(qe.x * Ve), y("beforeResize"), void 0 !== U) {
                                for (var i, n, a, s = 0; s < 3; s++) i = te[s], nt((s + U) * qe.x, i.el.style), a = H + s - 1, g.loop && 2 < Ht() && (a = l(a)), (n = Nt(a)) && (ee || n.needsUpdate || !n.bounds) ? (m.cleanSlide(n), m.setContent(i, a), 1 === s && (m.currItem = n, m.updateCurrZoomItem(!0)), n.needsUpdate = !1) : -1 === i.index && 0 <= a && m.setContent(i, a), n && n.container && (qt(n, Ue), Zt(n), it(n));
                                ee = !1
                            }
                        ...
                        zoomTo: function(t, e, i, n, a) {
                            e && (z = Z, Dt.x = Math.abs(e.x) - Qe.x, Dt.y = Math.abs(e.y) - Qe.y, w(He, Qe));
                            var s = b(t, !1),
                                o = {};
                            x("x", s, o, t), x("y", s, o, t);
                            var r = Z,
                        ...
                        if (Le) {
                            ...
                            if (0 !== e)
                                if (w(lt, Le[0]), dt.x = lt.x - ut.x, dt.y = lt.y - ut.y, Ee && 1 < e) {
                                    ...
                                    n < 0 && (n = 0), t, A(lt, ct, vt), Ne.x += vt.x - kt.x, Ne.y += vt.y - kt.y, w(kt, vt), Qe.x = c("x", i), Qe.y = c("y", i), De = Z < i, Z = i, tt()
                                } else {
                                    if (!$e) return;
                    ...
                    Et = function(e, t) {
                        ...
                        n && ((H += n) < 0 ? (H = g.loop ? Ht() - 1 : 0, a = !0) : H >= Ht() && (H = g.loop ? 0 : Ht() - 1, a = !0), a && !g.loop || (Ze += n, Ve -= n, i = !0));
                        var r, l = qe.x * Ve,
                            c = Math.abs(l - bt.x);
                        return r = i || l > bt.x == 0 < t.lastFlickSpeed.x ? (r = 0 < Math.abs(t.lastFlickSpeed.x) ? c / Math.abs(t.lastFlickSpeed.x) : 333, r = Math.min(r, 400), Math.max(r, 250)) : 333, yt === H && (i = !1), je = !0, y("mainScrollAnimStart"), I("mainScroll", bt.x, l, r, f.easing.cubic.out, u, function() {
                            _(), je = !1, yt = -1, !i && yt === H || m.updateCurrItem(), y("mainScrollAnimComplete")
                ...
                var Ot, Ft, Rt, Bt, Nt, Ht, Qt = function(o, e, r, t) {
                        var l;
                        Ot && clearTimeout(Ot), Rt = Bt = !0, o.initialLayout ? (l = o.initialLayout, o.initialLayout = null) : l = g.getThumbBoundsFn && g.getThumbBoundsFn(H);
                        ...
                        var u, h;
                        u = N, h = !m.currItem.src || m.currItem.loadError || g.showHideOpacity, o.miniImg && (o.miniImg.style.webkitBackfaceVisibility = "hidden"), r || (Z = l.w / o.w, Qe.x = l.x, Qe.y = l.y - pe, m[h ? "template" : "bg"].style.opacity = .001, tt()), T("initialZoom"), r && !u && f.removeClass(p, "pswp--animated-in"), h && (r ? f[(u ? "remove" : "add") + "Class"](p, "pswp--animate_opacity") : setTimeout(function() {
                ...
                i("Controller", {
                    publicMethods: {
                        ...
                        initController: function() {
                            f.extend(g, Wt, !0), m.items = Ft = e, Nt = m.getItemAt, (Ht = g.getNumItemsFn)() < 3 && (g.loop = !1), s("beforeChange", function(e) {
                                var t, i = g.preload,
                                    n = null === e || 0 <= e,
                                    a = Math.min(i[0], Ht()),
                                    s = Math.min(i[1], Ht());
                                for (t = 1; t <= (n ? s : a); t++) m.lazyLoadItem(H + t);
                                for (t = 1; t <= (n ? a : s); t++) m.lazyLoadItem(H - t)
                            }), s("initialLayout", function() {
                                m.currItem.initialLayout = g.getThumbBoundsFn && g.getThumbBoundsFn(H)
                            ...
                            if (a) {
                                ...
                                if (!a.src && a.html && (a.html.tagName ? s.appendChild(a.html) : s.innerHTML = a.html), $t(a), qt(a, Ue), !a.src || a.loadError || a.loaded) a.src && !a.loadError && ((n = f.createEl("pswp__img", "img")).style.opacity = 1, n.src = a.src, Zt(a, n), Yt(0, a, s, n));
                                    ...
                                    if (a.loadComplete = function(e) {
                                            if (R) {
                                                if (t && t.index === i) {
                                                    if ($t(e, !0)) return e.loadComplete = e.img = null, qt(e, Ue), it(e), void(t.index === H && m.updateCurrZoomItem());
                                ...
                                Rt || i !== H ? it(a) : (Ye = s.style, Qt(a, n || a.img)), t.el.innerHTML = "", t.el.appendChild(s)
                            } else t.el.innerHTML = ""
                        },
                ...
                i("Tap", {
                    ...
                    publicMethods: {
                        ...
                        handleMouseWheel: function(e) {
                            if (Z <= m.currItem.fitRatio) return g.modal && (!g.closeOnScroll || ot || Ce ? e.preventDefault() : re && 2 < Math.abs(e.deltaY) && (N = !0, m.close())), !0;
                ...
                I.init = function() {
                    r.extend(a.options, A, !0), S = a.options, h = r.getChildByClass(a.scrollWrap, "pswp__ui"), b = a.listen,
                        function() {
                            ...
                            P || s(), T && clearInterval(T), r.unbind(document, "mouseout", c), r.unbind(document, "mousemove", $), r.unbind(h, "pswpTap click", e), r.unbind(a.scrollWrap, "pswpTap", I.onGlobalTap), r.unbind(a.scrollWrap, "mouseover", I.onMouseOver), u && (r.unbind(document, u.eventK, I.updateFullscreen), u.isFullscreen() && (S.hideAnimationDuration = 0, u.exit()), u = null)
                        }), b("destroy", function() {
        ...
        function(m) {
            ...
            l(".main-loader").addClass("loader-hidden"), setTimeout(function() {
                ...
                function() {
                    ...
                    console.log(t, i), MyListing.Messages.open(t, i), setTimeout(function() {
