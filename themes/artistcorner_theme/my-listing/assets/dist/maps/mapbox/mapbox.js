! function(t) {
    ...
    MyListing.Maps = {
            ...
            if (!Array.isArray(MyListing.MapConfig.TypeRestrictions)) MyListing.MapConfig.TypeRestrictions = [];
            ...
            //console.log(i);
            //console.log("https://api.mapbox.com/geocoding/v5/mapbox.places/{query}.json".replace("{query}", encodeURIComponent(t)));
            jQuery.get({
