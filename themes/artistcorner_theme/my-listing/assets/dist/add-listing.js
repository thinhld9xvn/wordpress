! function(e) {
    ...
    jQuery(function(t) {
        ...
        var e, d, n = {};
        ! function() {
            var e = i("#submit-job-form .form-section-wrapper");
            if (!(e.length <= 1)) {
                var r = 70 * window.innerHeight / 100,
                ...
                i(window).on("scroll", MyListing.Helpers.debounce(function() {
                    ...
                    }), e.removeClass("active"), n.Nav.clearAll();
                    var t = !1;
                    d.reverse().forEach(function(e) {
                        if (!t) return e.el.classList.add("active"), t = !0, void n.Nav.highlight(e.el.id);
                        e.max_diff <= 0 && (e.el.classList.add("active"), n.Nav.highlight(e.el.id))
                    })
                }, 20)).scroll()
            }
        }(), e = i("#submit-job-form .form-section-wrapper:not(#form-section-submit)"), (d = i(".add-listing-nav")).length && (n.Nav = {
            clearAll: function() {
        ...
        }, e.length <= 1 ? d.hide() : e.each(function(e, t) {
            var n = i(this).find(".pf-head h5").html();
            if ("string" == typeof n) {
                var a = i('<li id="' + i(this).attr("id") + '-nav"><a href="#"><i><span></span></i>' + n + "</a></li>");
                a.click(function(e) {
                    e.preventDefault(), i("html, body").animate({
                        scrollTop: i(t).offset().top - 5 * window.innerHeight / 100 - 90
                    })
                }), d.find("ul").append(a)
            }
        }))
                ...
                function n() {
                    if (u.prop("checked")) {
                        ...
                        if (e.length && t.length && n.length && a) {
                            e = moment(e), t = moment(t), (n = moment(n)).set({
                                hour: 23,
                                minute: 59,
                                second: 59
                            }), "weeks" === i && (i = "days", a *= 7), "years" === i && (i = "months", a *= 12);
