...
<div class="row">
	<div class="col-md-4">
		<?php if ( mylisting()->get( 'stats.show_views' ) !== false && 
					UserMemberShip::has_action_permission(UserPermission::SHOW_VIEWS_IN_DASHBOARD) ): ?>
			<?php require locate_template( 'templates/dashboard/stats/widgets/views.php' ) ?>
		<?php endif ?>

		<?php if ( mylisting()->get( 'stats.show_uviews' ) !== false && 
					UserMemberShip::has_action_permission(UserPermission::SHOW_UNIQUE_VIEWS_IN_DASHBOARD) ): ?>
	...
	<div class="col-md-8">
		...
		<?php if ( mylisting()->get( 'stats.enable_chart' ) !== false && 
					UserMemberShip::has_action_permission(UserPermission::SHOW_VISITS_IN_DASHBOARD) ): ?>
