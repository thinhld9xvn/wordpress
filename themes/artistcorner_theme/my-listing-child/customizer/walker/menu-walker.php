<?php 
	...
	class Unicorn_NavMenu_Walker extends Walker_Nav_Menu {
		 ...
		 **/
		 public function start_lvl( &$output, $depth = 0, $args = array() ) {
		    ...
		    $output .= "\n$indent<ul class=\"sub-menu i-dropdown\">\n";
		 ...
		 **/
		 public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            if ( $args->walker->has_children ) :
	        	...
	        	$item_output .= "<div class=\"submenu-toggle\"><i class=\"material-icons\">arrow_drop_down</i></div>";
