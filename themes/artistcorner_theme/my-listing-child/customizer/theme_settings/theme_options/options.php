...
class MyThemeOptionPage {
     ...
     */       
     public function __construct() {
        ...
        include dirname(__FILE__) . '/my_options/theme_options.php';
    ...
    public function add_plugin_page() {
        ...
        add_menu_page(__( 'Theme Option', 'unicorn' ), // Thay title của trang Theme Option
            'Theme Option', // Thay tên hiển thị trên Menu
            'manage_options', 'theme-option', null, CHILD_THEME_DIR_URI . '/customizer/theme_settings/theme_options/theme_option.png' // Thay icon của bạn
            );           
                ...
                <div class="theme_field_box">
                    ...
                    <textarea id="<?php echo $field['id'] . '-id' ?>" 
                              ...
                              <?php while ( $attribute_value = current( $field['attributes'] ) ) : 
                                ...
                                endwhile; ?>><?= isset( $this->options[ $field['id'] . '-id' ] ) ? htmlentities($this->options[ $field['id'] . '-id' ]) : '' ?></textarea>
...
function theme_option_load_style() {
    ...
    if ( false !== strpos( $request_uri, 'theme-option' ) ) :
        ...
        wp_enqueue_style('theme-option-stylesheet', CHILD_THEME_DIR_URI . '/customizer/theme_settings/theme_options/css/style.min.css');
        
        wp_enqueue_script('theme-option-field_media_jquery', CHILD_THEME_DIR_URI . '/customizer/theme_settings/theme_options/js/field_media.min.js');
        wp_enqueue_script('theme-option-field_editor_jquery', CHILD_THEME_DIR_URI . '/customizer/theme_settings/theme_options/js/field_editor.min.js');
        wp_enqueue_script('theme-option-field_typical_jquery', CHILD_THEME_DIR_URI . '/customizer/theme_settings/theme_options/js/field_typical.min.js');
