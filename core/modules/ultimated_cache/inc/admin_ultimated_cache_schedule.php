<?php 
	...
	$ultimate_cache_deleted_timeout = ! empty( $ultimate_cache_options['ultimate-cache-delete-timeout-id'] ) || (int) $ultimate_cache_options['ultimate-cache-delete-timeout-id'] > 0 ? (int) $ultimate_cache_options['ultimate-cache-delete-timeout-id'] : 24*60*60*1000; // mặc định là 24h sẽ xóa cache một lần
