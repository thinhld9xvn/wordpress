<?php 
	...
	class qTranslate_Nav_Menus {
		...
		public function register_qtranslate_nav_menus() {
			...
			include get_template_directory() . '/qTranslate/options/config.php';			
			...
			foreach ( $nav_menus as $nav_menu ) :
				...
				if ( empty( $nav_menu->qtranslate_term_langcode ) ) :

					$nav_menu->qtranslate_term_langcode = $active_langcode;

					wp_update_term( $nav_menu->term_id, 'nav_menu', array('qtranslate_term_langcode' => $nav_menu->qtranslate_term_langcode) );
