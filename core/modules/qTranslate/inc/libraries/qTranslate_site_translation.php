<?php 
    ...
    function qtranslate_ajax_translation() {

        global $q_db;

        $results = $q_db->get_all_translate_strings();
    ...
    add_action('wp_ajax_sb_qtranslate_ajax_translation', 'qtranslate_ajax_translation');
    add_action('wp_ajax_nopriv_sb_qtranslate_ajax_translation', 'qtranslate_ajax_translation');