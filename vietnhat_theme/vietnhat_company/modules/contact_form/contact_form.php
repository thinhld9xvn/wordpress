<?php 
	...
	function contact_form_admin_stylesheet_scripts_loader() {
		...
		if ( 'pv-contact-form' === get_post_type() ) :
			...
			wp_enqueue_script( 'pvcf-jquery-admin-add-fields', PVCF_DIRECTORY_JS . '/pvcf_admin_add_fields.js', array('jquery'), '1.0.0', true );
			wp_enqueue_script( 'pvcf-jquery-admin-form-content', PVCF_DIRECTORY_JS . '/pvcf_admin_form_content.js', array('jquery'), '1.0.0', true );
			...
			wp_enqueue_script( 'pvcf-jquery-admin-settings', PVCF_DIRECTORY_JS . '/pvcf_admin_settings.js', array('jquery'), '1.0.0', true );
