            ...
            <tr>  
                ...
                <td>
                    ...
                    <div class="metabox_field">
                        ...
                        <label for="<?php echo $field['id'] . '-checkbox' ?>">

                            <input type="checkbox" id="<?php echo $field['id'] . '-checkbox' ?>"
                                   class="txtFTypical tFChange checkbox_field_metabox" 
                                   <?php echo 'true' === $term_meta[ $field['id'] ] ? 'checked' : '' ?> />
        ...
        function extra_select_field( $field, $term_meta) {  ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <select id="sl-<?php echo $field['id'] ?>" class="txtFTypical tFChange slTermLayout select_field_metabox">
        ...
        function extra_front_select_field( $field, $term_meta) { ?>
            ...
            <div class="form-field">
                ...
                <div class="metabox-field">
                    ...
                    <select id="sl-<?php echo $field['id'] ?>" class="txtFTypical tFChange slFrontTermLayout select_field_metabox">
  ...
  <?php    
        ...
        function extra_term_fields( $tag ) {    //check for existing featured ID
            ...
            foreach ( $metaboxes as $metabox ) : ?>  
                ...
                <table class="form-table <?= isset( $metabox['term_metaboxes_layout'] ) && 
                                             $metabox['term_metaboxes_layout'] ? '' : 'form_table_layout ' . $metabox['layout'] . ' mb_hidden' ?>">
        <?php
    ...
    <?php
        ...
        function extra_front_term_fields( $tag ) {    //check for existing featured ID
            ...
            foreach ( $metaboxes as $metabox ) : ?>
                ...
                <div class="form-table <?= isset( $metabox['term_metaboxes_layout'] ) && 
                                           $metabox['term_metaboxes_layout'] ? '' : 'form_table_layout ' . $metabox['layout'] . ' mb_hidden' ?>">
