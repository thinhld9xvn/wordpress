<?php 
    function sb_pvcf_admin_event_script() {          

        wp_enqueue_script('pvcf-ajax-admin-event', PVCF_DIRECTORY_JS . '/pvcf_admin_event.min.js', array('jquery'), 'v1.0.0' , true);      

    }
    add_action('admin_enqueue_scripts', 'sb_pvcf_admin_event_script');
