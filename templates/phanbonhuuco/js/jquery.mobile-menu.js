function showNavMobileMenuEvent() {
    ...
    const mobile_menu_node = jQuery('#header #menu > nav > ul')[0],
         mobile_button_node = jQuery('#header #menu > nav button')[0];
...
function hideNavMobileMenuWhenScroll() {
    ...
    const $mobile_menu = jQuery('#header #menu > nav > ul');
...
function expandSubMobileMenu() {
    ...
    jQuery('#header #menu > nav .toggle').click(function(e) {
