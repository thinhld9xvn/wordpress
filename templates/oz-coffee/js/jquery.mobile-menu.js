function showNavMobileMenuEvent() {
    ...
    const mobile_menu_node = jQuery('#header .main-mobile-menu')[0],
         mobile_button_node = jQuery('#header .main-mobile-menu button')[0];
...
function hideNavMobileMenuWhenScroll() {
    ...
    const $mobile_menu = jQuery('#header .main-mobile-menu');
...
function expandSubMobileMenu() {
    ...
    jQuery('.main-mobile-menu .mobile-menu .toggle').click(function(e) {
