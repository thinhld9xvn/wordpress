...
var slider = {
  ...
  initBxSlider: function initBxSlider() {
    ...
    jQuery('.bxslider').each(function (index, elem) {
      ...
      if ($slider.hasClass('--fademode')) {
        options.mode = 'fade';
        options.pause = pauseOption; //options.pager = true;
      }

      if ($slider.hasClass('--carousel')) {
        var numShowItems = $slider.data('numshow') ? parseInt($slider.data('numshow')) : 1,
  ...
  initLightGallery: function initLightGallery() {
